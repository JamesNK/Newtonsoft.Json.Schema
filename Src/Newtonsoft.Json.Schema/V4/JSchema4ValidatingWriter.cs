...
{
    public class JSchema4ValidatingWriter : JsonWriter
    {
        internal class WriterValidator : Validator
        {
            private readonly JSchema4ValidatingWriter _writer;

            public WriterValidator(JSchema4ValidatingWriter writer)
                : base(writer)
            {
                _writer = writer;
            }
