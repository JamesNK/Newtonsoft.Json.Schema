...
namespace Newtonsoft.Json.Schema.V4.Infrastructure.Validation
{
    ...
    {
        public PrimativeScope(Context context, Scope scope, int initialDepth, JSchema4 schema, bool raiseErrors)
        ...
        private bool ValidateNull(JSchema4 schema)
        {
            return TestType(schema, JSchemaType.Null);
        }

        private bool ValidateBoolean(JSchema4 schema)
        {
            return TestType(schema, JSchemaType.Boolean);
        }

        private bool ValidateInteger(JSchema4 schema, object value)
        {
        ...
        private bool ValidateString(JSchema4 schema, string value)
        {
        ...
        private bool ValidateFloat(JSchema4 schema, double value)
        {
