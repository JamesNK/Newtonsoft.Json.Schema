...
namespace Newtonsoft.Json.Schema.V4.Infrastructure.Validation
{
    internal abstract class SchemaScope : Scope
    {
        ...
        protected SchemaScope(ContextBase context, Scope parent, int initialDepth, JSchema4 schema)
        ...
        public static SchemaScope CreateTokenScope(JsonToken token, JSchema4 schema, ContextBase context, Scope parent, int depth)
        {
            SchemaScope scope;
        ...
        internal override void RaiseError(string message, JSchema4 schema, IList<ISchemaError> childErrors)
        {
            IsValid = false;
